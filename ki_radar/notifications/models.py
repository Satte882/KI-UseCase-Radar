...
class EvidenceLink(TimeStampedModel):
    ...
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, null=True, on_delete=models.SET_NULL, related_name="created_evidence_links")
...
class NotificationLog(TimeStampedModel):
    ...
    use_case = models.ForeignKey(UseCase, null=True, blank=True, on_delete=models.SET_NULL, related_name="notification_logs")
